...
$table1->addCell(2000)->addText($v);
}

}

$word->addTableStyle('table1', $styleTable,$styleFirstRow);
$section1->addText("Asistió = A "."Falta = F "."Tarde = T "."Justificado = J");
$section1->addText("");
$section1->addText("");
$section1->addText("F.__________________________");
$section1->addText("             Dirección");
