...
<div class="btn-group  pull-right">
	<a href="index.php?view=newproduct" class="btn btn-default">Agregar Colaborador</a>
<div class="btn-group pull-right">
...
<div class="clearfix"></div>
	...
	<div class="jumbotron">
		...
		<p>No se han agregado colaboradores a la base de datos, puedes agregar uno dando click en el boton <b>"Agregar Colaborador"</b>.</p>
	</div>
	<?php
}
