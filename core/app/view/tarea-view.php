...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="row">
	<div class="col-md-12">
	<br>
  <form class="form-horizontal" method="post" id="aggtarea" action="index.php?view=agregarTarea" role="form">
  <div class="form-group">

    <label for="inputEmail1" class="col-lg-2 control-label">Tarea</label>
    <div class="col-md-6">
      <input type="text" name="tarea" class="form-control" id="tarea" placeholder="ex. Siembra "required="required">
    </div>
  </div>
...
$sql = "select idtarea as codigo, tarea  from Tarea";
